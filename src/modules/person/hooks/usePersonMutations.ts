...
import { type CreatePersonDto, type UpdatePersonDto } from '../types/person.types'
...
export function useCreatePerson(workspaceId: string) {
  ...
  return useMutation({
    mutationFn: (data: CreatePersonDto) => personService.createPerson(workspaceId, data),
    onSuccess: () => {
...
export function useUpdatePerson(workspaceId: string, personId: string) {
  ...
  return useMutation({
    mutationFn: (data: UpdatePersonDto) => personService.updatePerson(workspaceId, personId, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: personKeys.lists() })
      queryClient.invalidateQueries({
...
export function useDeletePerson(workspaceId: string) {
  ...
  return useMutation({
    mutationFn: (personId: string) => personService.deletePerson(workspaceId, personId),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: personKeys.lists() })
      queryClient.invalidateQueries({
        queryKey: personKeys.stats(workspaceId),
...
export function useHardDeletePerson(workspaceId: string) {
  ...
  return useMutation({
    mutationFn: (personId: string) => personService.hardDeletePerson(workspaceId, personId),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: personKeys.lists() })
      queryClient.invalidateQueries({
        queryKey: personKeys.stats(workspaceId),
...
export function useRestorePerson(workspaceId: string) {
  ...
  return useMutation({
    mutationFn: (personId: string) => personService.restorePerson(workspaceId, personId),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: personKeys.lists() })
      queryClient.invalidateQueries({
        queryKey: personKeys.stats(workspaceId),
