...
export const workspaceService = {
  ...
  async updateWorkspaceStatus(workspaceId: string, status: WorkspaceStatus): Promise<Workspace> {
  ...
  async updateFavoriteModules(
    ...
    const response = await api.patch(`/workspaces/${workspaceId}/modules/favorites`, {
      favoriteModuleIds,
    })
    return response.data.modules
  },
  ...
  async updateEnabledModules(workspaceId: string, modules: string[]): Promise<string[]> {
